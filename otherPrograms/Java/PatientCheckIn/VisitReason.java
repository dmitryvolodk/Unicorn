...
public class VisitReason implements PatientPrecheckin,Cloneable {
    ...
    private String assessRegularActivities, assessInstrumentalActivities, assessYangAlcoholUse,                 //
            assessOthersAlcoholUse, assessNervousFeeling, assessWorryingFeeling, assessHopeless,                // Assessement variables 
            assessInterest, assessGeneralHealth, assessMouthHealth, assessMisfortune, assessMedicationAdherence;//
    private final String routineDiscription = "Your physical examination is a review of your medical history, preventative \n" +
    ...
    public String getRoutineDiscription() {
        return routineDiscription;
    }
    ...
    public void decisionMaking(java.io.PrintWriter output, char routine, String issues){
        ...
        if(routine == 'y'){
            ...
            nonRoutineVisit(output, issues);
        }

    }

    public void routineVisit(){
        System.out.println(routineDiscription);
    }
    ...
    public void performAssessement(java.io.PrintWriter output, String assessRegularActivities, String assessInstrumentalActivities,
        ...
        System.out.println("In the past 7 days, did you need help from others to perform everyday activities such " +
         ...
         System.out.println(assessRegularActivities);
        ...
        output.println("In the past 7 days, did you need help from others to perform everyday activities such " +
                "as eating, getting dressed, grooming, bathing, walking, or using the toilet? No/Yes");
        output.println(assessRegularActivities);
        /* File output */
        ...
        System.out.println(assessInstrumentalActivities);
        ...
        System.out.println(assessNervousFeeling);
        ...
        System.out.println(assessMedicationAdherence);
